...
| `/api/agent/scout/reddit`         | POST   | 30 creditsedits                           |
| `/api/agent/scout/reddit/{runId}` | GET    | free (poll)                          |
| `/api/agent/gaps`                 | GET    | free                                 |
| `/api/agent/gaps/generate`        | POST   | 40 creditsedits                           |
| `/api/agent/competitors/discover` | POST   | 20 creditsedits                           |
| `/api/agent/competitors/scout`    | POST   | 25-50 credits                        |
| `/api/agent/products`             | POST   | 1 creditsedit                             |
...
| `/api/agent/shorts/script`        | POST   | 1 creditsedit                             |
| `/api/agent/shorts/avatar`        | POST   | 3 creditsedits                            |
| `/api/agent/shorts`               | POST   | 60-185 credits (by duration)         |
| `/api/agent/shorts/{id}`          | GET    | free (poll)                          |
| `/api/agent/shorts/merge`         | POST   | 5 creditsedits                            |
