...
| Tool | Description | Endpoint |
|---|---|---|
| `article.generate` | Generate and publish an SEO-optimized article. Returns the published article with its URL when complete. May take 30-90 seconds. | `POST /api/agent/autopilot` |
