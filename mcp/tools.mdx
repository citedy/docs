...
description: Complete list of 53 MCP tools available via the Citedy MCP server
---

# MCP Tools Reference

The Citedy MCP server exposes **53 tools**. Each tool maps to an Agent API endpoint.
...
| `article.get` | Get queued article generation status or final generated article result by ID. | `GET /api/agent/articles/{id}` |
