...
description: Complete list of 57 MCP tools available via the Citedy MCP server
---

# MCP Tools Reference

The Citedy MCP server exposes **57 tools**. Each tool maps to an Agent API endpoint.
