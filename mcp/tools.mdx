...
| `shorts.publish` | Publish a generated short video directly to YouTube Shorts and/or Instagram Reels. Does not require an article — derives title/description/hashtags from speech_text via LLM. Publication is free on all platforms (per product decision 2026-04-15). Returns per-platform results and timings. | `POST /api/agent/shorts/publish` |
