...
description: Complete list of 52 MCP tools available via the Citedy MCP server
---

# MCP Tools Reference

The Citedy MCP server exposes **52 tools**. Each tool maps to an Agent API endpoint.
