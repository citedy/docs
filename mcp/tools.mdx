...
description: Complete list of 58 MCP tools available via the Citedy MCP server
---

# MCP Tools Reference

The Citedy MCP server exposes **58 tools**. Each tool maps to an Agent API endpoint.
...
| `shorts.publish` | Publish a generated short video directly to YouTube Shorts and/or Instagram Reels. Does not require an article — derives title/description/hashtags from speech_text via LLM. Instagram Reels costs 5 credits; YouTube Shorts is free. Returns per-platform results and timings. | `POST /api/agent/shorts/publish` |
