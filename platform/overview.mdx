...
**Contract Snapshot**: 61 Agent API operations · 52 MCP tools
...
- `clawhub-skill/SKILL.md` — MCP skill definition for ClawhubAI marketplace
- `public/skill.md` — Human-readable skill reference (no scripts)
- `docs/subtitle-microservice/README.md` — VPS subtitle service architecture
- `docs/billing/README.md` — Full billing and credit system
- `docs/auth/README.md` — Tenant authentication system
